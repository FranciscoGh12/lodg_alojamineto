...
<body>
        ...
        <header class="site-navbar" role="banner">
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <h1 class="mb-0 site-logo"><a href="index.html" class="text-white h2 mb-0"><img class="lodg-logo" src="{{url('frontend/images/logolodg.png')}}" alt=""></a></h1>
                    </div>
    ...
    <div class="site-blocks-cover overlay" style="background-image: url('frontend/images/TLACOTALPAN.jpg');" data-aos="fade"
